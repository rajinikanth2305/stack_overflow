...
const TrekReviews = ({ slice }) => {
  ...
  return (
    <div>
      {trekUserReviews && trekUserReviews.length > 0 && (
        <div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-12">
                  <div className="p-text-4">
                    Over 20,000 people trek with Indiahikes each year and vouch
                    for our unmatched safety standards. See what they have to
                    say below. Click to read more.
                  </div>
                </div>
              </div>
              <div className="my-3">
