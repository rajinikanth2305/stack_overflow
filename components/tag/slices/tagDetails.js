...
const TagDetails = ({ slice }) => {
    ...
    const articlesByAthorName = tagArticles && tagArticles?.results?.filter(x => x?.data?.categories === tagName);
    ...
    return (
        <>
            <div className="container my-4">
                <div>
                    <h2 className="title-h3 mb-4"><span className="border-bottom-custom">{tagName}</span></h2>
                </div>
                <div>
