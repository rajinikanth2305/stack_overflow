        ...
        <div className="col-lg-6 col-md-12">
          <Card>
              ...
              <Accordion.Toggle variant="link" eventKey={i + 1}>
                <div className="d-flex align-items-center">
                  <div className="flex-grow-1">
                    <p className="p-text-1 mb-1"><b>{data.support_title[0].text}</b></p>
                    <p className="p-text-3 m-0">{data.support_sub_title[0].text}</p>
                  </div>
                  <div>
                    <div>
            ...
            <Accordion.Collapse eventKey={i + 1}>
              <Card.Body>{data.support_details[0].text}</Card.Body>
            </Accordion.Collapse>
          </Card>
        </div>
      </>
