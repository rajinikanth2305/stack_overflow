      ...
      <div key={i}>
        <div className="mx-4 mmx-0">
          <div alt="imgs" className="campsites_images cursor-pointer">
            {data?.photo_contest_images?.url ? (
              <Image
                src={data?.photo_contest_images?.url}
                layout="fill"
                objectFit="cover"
                objectPosition="50% 50%"
                onClick={() => {
                  setImgUrl(data?.photo_contest_images?.url);
                  setShow(true);
                }}
                unoptimized
              />
    ...
    <>
      <div id="goToCampsite">
        <div className="container">
          ...
          <div className="mt-4 mb-4 mpb-5 mmt-0 mmb-0">
