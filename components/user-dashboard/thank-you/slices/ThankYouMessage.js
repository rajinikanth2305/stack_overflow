              ...
              <div className="col-md-6 col-12">
                <p className="p-text-1-fgt mb-4">
                  {status === "success" && type === true && (
                    <>
                      <span className="border-bottom-custom-1 pb-1">
                        Success! Your payment for backpack offloading is
                        confirmed . We have mailed you a payment receipt.{" "}
                      </span>
                    </>
                  )}
                  {status === "success" && type === false && (
                    <>
                      <span className="border-bottom-custom-1 pb-1">
                        Success! Your payment for trek booking is confirmed . We
                        have mailed you a payment receipt.{" "}
                      </span>
                    </>
                  )}
                  {status === "failed" && (
                  ...
                  {status === "cancelled" && (
                    <span className="border-bottom-custom-1 pb-1">
                      {" "}
                      Your payment action cancelled !{" "}
                    </span>
                  )}
                </p>

                <p className="p-text-3-fg">
                  You will be redirected to the Indiahikes dashboard in 5
                  seconds
                </p>
                <p className="h-text">
                  <a href="/user-dashboard/user-upcoming-treks">
