...
const FitnessApproval = forwardRef((props, ref) => {
  ...
  const deleteFitnessImage = (documentId) => {
    deleteFitnessDocument(participantId, documentId).then(() =>
      getUploadedDocumentContents(participantId)
    );
              ...
              <div className="col-lg-7 col-md-12">
                <div>
                  <p className="p-text-4">
                    Upload the screenshots of your runs here.
                  </p>
                  <p className="m-0 p-text-small-brown">
                    Only 5 files allowed to upload and each file size should be
                    2MB and total 10 MB.
                  </p>
                </div>
                <FileUpload
                ...
                {imageIndexs.length === previewDocuments.length &&
                  imageIndexs?.map((imageId, index) => {
                    const pdata = previewDocuments?.[index];
                    const url = window.URL.createObjectURL(pdata);

                    return (
                      <div
                        className="d-flex align-items-center  col-lg-12 col-md-12 col-12"
                        key={imageId}
                      >
                        <Image
                          src={url}
                ...
                <div className="p-text-small-brown mt-2">
                  ...
                  <p className="mb-1">
                    1. Install a running app like Nike Run or Strava on your
                    phone.
                  </p>
                  <p className="mb-1">
                  ...
                  <p className="mb-1">
                    4. After one month, take another screenshot with a summary
                    of your month's run.
                  </p>
                  <p className="mb-1">
                    5. Upload these two screenshots 15 days before the start of
                    the trek, not later than that.
                  </p>
                  <p className="mb-1">
                    6. Our Experience Coordinators will review your fitness and
                    approve it or advise you further.
                  </p>
                </div>
              </div>
            </div>
